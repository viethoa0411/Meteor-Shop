...
@section('title', 'Yêu cầu rút tiền thành công')
...
<style>
    ...
    .withdraw-info-item:last-child { border-bottom: none; }
</style>
@endpush
...
<div class="success-wrapper">
    <div class="success-card">
        ...
        <p class="text-muted">Yêu cầu rút tiền của bạn đang chờ xử lý từ admin.</p>

        <div class="withdraw-info">
            <div class="withdraw-info-item">
                <span class="text-muted">Mã yêu cầu</span>
                <span class="fw-bold text-primary">{{ $withdraw->request_code }}</span>
            </div>
            <div class="withdraw-info-item">
                <span class="text-muted">Số tiền rút</span>
                <span class="fw-bold text-danger">{{ $withdraw->formatted_amount }}</span>
            </div>
            <div class="withdraw-info-item">
                <span class="text-muted">Ngân hàng</span>
                <span class="fw-semibold">{{ $withdraw->bank_name }}</span>
            </div>
            <div class="withdraw-info-item">
                <span class="text-muted">Số tài khoản</span>
                <span class="fw-semibold">{{ $withdraw->account_number }}</span>
            </div>
            <div class="withdraw-info-item">
                <span class="text-muted">Chủ tài khoản</span>
                <span class="fw-semibold">{{ $withdraw->account_holder }}</span>
            </div>
            <div class="withdraw-info-item">
                <span class="text-muted">Trạng thái</span>
                <span class="badge bg-warning">{{ $withdraw->status_label }}</span>
            </div>
        </div>
