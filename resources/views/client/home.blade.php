...
@section('content')
 ...
 {{-- Hero Banner / Slider --}} <section class="hero-banner">
        <div class="hero-banner-inner">
            @if ($banners->count() > 0)
                    ...
                    <div class="hero-banner-track">
                        @foreach ($banners as $index => $banner)
                            ...
                            <div class="hero-slide">
                                @if ($bannerImage)
                                    <img class="hero-slide-image" src="{{ $bannerImage }}"
                                ...
                                @else
                                    <img class="hero-slide-image" src="https://via.placeholder.com/1600x700?text=Banner"
                                        @unless ($isFirst) loading="lazy" @endunless
                                ...
                                <div class="hero-slide-content container">
                                    ...
                                    @if (!empty($banner->link))
                                        <a href="{{ $banner->link }}" title="Xem chi tiết {{ $banner->title ?? 'banner' }}">
                ...
                @if ($banners->count() > 1)
                    ...
                    <div class="hero-dots">
                        @foreach ($banners as $index => $banner)
                            <button type="button" class="hero-dot {{ $index === 0 ? 'is-active' : '' }}"
                                data-index="{{ $index }}" aria-label="Chuyển đến banner {{ $index + 1 }}"
