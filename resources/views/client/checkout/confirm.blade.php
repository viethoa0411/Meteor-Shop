    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="background:transparent; padding:0;">
                ...
                <li class="breadcrumb-item"><a href="{{ route('client.checkout.index') }}">Thanh toán</a></li>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="bi bi-box-seam me-2"></i>Sản phẩm</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="ms-3 flex-grow-1">
                                ...
                                @if ($variant)
                                    <p class="text-muted small mb-1">
                                        <strong>Màu:</strong> {{ $variant->color_name ?? 'N/A' }}
                                    </p>
                ...
                @if ($checkoutSession['payment_method'] == 'bank' && $qrCodeUrl && $walletInfo)
            ...
            function copyToClipboard(text, button) {
                navigator.clipboard.writeText(text).then(function() {
                    ...
                    setTimeout(function() {
                        ...
                        if (text.includes('Thanh toan') || text.includes('{{ $walletInfo->bank_account ?? '' }}')) {
