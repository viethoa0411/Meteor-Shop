        ...
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                ...
                <div class="d-flex gap-1 align-items-center">
                    ...
                    <a href="{{ route('admin.blogs.list', ['status' => 'active'] + request()->except('status')) }}"
                    ...
                    <a href="{{ route('admin.blogs.list', ['status' => 'inactive'] + request()->except('status')) }}"
                ...
                {{-- Ô tìm kiếm --}}
                <form action="{{ route('admin.blogs.list') }}" method="GET"
                    ...
                    <div class="input-group w-100">
                        ...
                        @if (request('keyword'))
                            <a href="{{ route('admin.blogs.list', ['status' => request('status', 'all')]) }}" class="btn btn-outline-secondary">
                ...
                <tbody>
                    @foreach ($blogs as $index => $blog)
                        <tr>
                            ...
                            <td data-label="Ảnh">
                                @if ($blog->thumbnail)
                                    <img src="{{ asset('blogs/images/' . $blog->thumbnail) }}" alt="{{ $blog->title }}" class="thumbnail-img">
                                @else
