...
<body>
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <a href="/" class="{{ request()->is('/') ? 'active' : '' }}"><i class="bi bi-house-door-fill me-2"></i> Dashboard</a>
            <a href="/categories" class="{{ request()->is('categories') ? 'active' : '' }}"><i class="bi bi-folder-plus me-2"></i> Danh mục</a>
            <a href="#"><i class="bi bi-box-seam me-2"></i> Sản phẩm</a>
            <a href="{{ route('admin.orders.index') }}" class="{{ request()->is('admin/orders*') ? 'active' : '' }}"><i class="bi bi-cart-fill me-2"></i> Đơn hàng</a>
