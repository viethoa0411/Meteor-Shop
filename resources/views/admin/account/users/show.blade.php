    ...
    <div class="container py-4">
        ...
        <div class="card shadow-sm border-0">
           ...
           <div class="card-footer text-end">
                <a href="{{ route('admin.account.users.edit', $user->id) }}" class="btn btn-info">
                    <i class="bi bi-pencil-square"></i> Sửa
                </a>

                @if (!$user->deleted_at)
                <form action="{{ route('admin.account.users.destroy', $user->id) }}" method="POST" class="d-inline"
                ...
                @else
                    <form action="{{ route('admin.account.users.restore', $user->id) }}" method="POST" class="d-inline">
                        @csrf
