    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-lg-10 mx-auto">
                ...
                <<<<<<< HEAD {{-- Hiển thị thông báo --}} @if (session('success'))
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <form id="productUpdate" action="{{ route('admin.products.update', $product->id) }}"
                                ...
                                <div class="card mt-3">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h4 class="mb-0">Sửa sản phẩm: <span
                                                class="text-primary">{{ $product->name }}</span></h4>
                                    </div>

                                    <div class="card-body">
                                        <form id="productUpdate" action="{{ route('admin.products.update', $product) }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <<<<<<< HEAD======={{-- Biến thể --}} <h5>Biến thể đã lưu</h5>
                                                <div class="row">
                                                ...
                                                <<<<<<< HEAD {{-- Ảnh sản phẩm --}}======={{-- Ảnh đại diện --}}>>>>>>>
                                                    quan_ly_products
                                                    ...
                                                    <div class="d-flex mt-4">
                                                        <div class="ms-auto">
                                                            <a href="{{ route('admin.products.list') }}"
                                                                class="btn btn-secondary me-2">Quay
                                                                lại</a>
