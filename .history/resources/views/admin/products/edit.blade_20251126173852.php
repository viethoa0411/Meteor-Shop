                        ...
                        <div class="variant-item border rounded p-3 mb-2">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input name="variants[{{ $idx }}][color_name]" class="form-control"
                                        value="{{ $v->color_name }}">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="color" name="variants[{{ $idx }}][color_code]"
                                        class="form-control form-control-color" value="{{ $v->color_code }}">
                                </div>

                                <div class="col-md-2">
                                    <label>Dài</label>
                                    <input type="number" step="0.01" name="variants[{{ $idx }}][length]"
                                        class="form-control" value="{{ $v->length }}">
                                </div>

                                <div class="col-md-2">
                                    <label>Rộng</label>
                                    <input type="number" step="0.01" name="variants[{{ $idx }}][width]"
                                        class="form-control" value="{{ $v->width }}">
                                </div>

                                <div class="col-md-2">
                                    <label>Cao</label>
                                    <input type="number" step="0.01" name="variants[{{ $idx }}][height]"
                                        class="form-control" value="{{ $v->height }}">
                                </div>

                                <div class="col-md-2 mt-3">
                                    <label>Tồn</label>
                                    <input type="number" name="variants[{{ $idx }}][stock]" class="form-control"
                                        value="{{ $v->stock }}">
                                </div>
