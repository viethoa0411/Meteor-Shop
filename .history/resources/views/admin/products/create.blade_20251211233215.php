                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{-- <input
                                        ...
                                        value="1.25"
                                        style="width: 80px; padding: 6px; border: 1px solid #ccc; border-radius: 4px; margin-right: 8px;"
                                    />
                                    ...
                                    <input type="text" id="weight" placeholder="Trọng lượng" class="form-control"                                        
                                                />
