...
<body>
    ...
    @auth
        <div class="d-flex align-items-center gap-3">
            <span class="text-white small">Xin chào, {{ Auth::user()->name }}</span>
            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-outline-light btn-sm px-3 py-1">Đăng xuất</button>
            </form>
        </div>
    @else
        <div class="d-flex auth-btn-wrap">
